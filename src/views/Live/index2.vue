  ...
  <div :class="`live ${isSousuo?'live_sousuo':''} ${workIsSousuo?'live_sousuo1':''} ${workIsSousuo&&isSousuo?'live_sousuo2':''}`">
      <div class="live_left">
          ...
          <div class="video_btn_wrap">
              <ul>
                <li @click="SendHome"><span><img src="@/assets/images/fabu.png" alt=""></span> 发布作业</li>
                <li><span><img src="@/assets/images/gongxian.png" alt=""></span> 共享文件</li>
                <li><span><img src="@/assets/images/jianli.png" alt=""></span> 发放激励</li>
                <li><span><img src="@/assets/images/dianming.png" alt=""></span> 随机点名</li>
                <li><span><img src="@/assets/images/wenti.png" alt=""></span> 发布问题</li>
              </ul>
              <div>
                <div @click="Settting">
      ...
      <sendHome1 :sendHome.sync="sendHome" v-if="sendHome"></sendHome1>
      <settting1 :settting.sync="settting" v-if="settting"></settting1>
  </div>
</template>

<script>
import sendHome1 from './Components/teach/sendHome1.vue';
import settting1 from './Components/teach/settting1.vue';
  export default {
    components:{sendHome1, settting1},
    data(){
      return{
        inputValue:'',
        sendBtnState:false,
